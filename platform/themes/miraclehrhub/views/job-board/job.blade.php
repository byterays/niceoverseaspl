            ...
            <div @class(['col-md-12 col-sm-12 col-12', 'col-lg-8'=> (! $job->hide_company && $company->id)])>
                ...
                <div class="mt-4">
                    ...
                    <div class="job-board-street-map-container">
                        <div class="job-board-street-map" data-popup-id="#street-map-popup-template" data-center="{{ json_encode([$job->latitude, $job->longitude]) }}" data-map-icon="{{ $job->salary_text }}"></div>
                    </div>
                ...
                <div class="single-apply-jobs">
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            @php($classButtonApplyBottom = 'btn btn-default hiredots-btn mr-15')
                            {!! Theme::partial('apply-button', [
                            'job' => $job,
