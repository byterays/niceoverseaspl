@php
    ...
    $isMapActive = false; // (theme_option('show_map_on_jobs_page', 'yes') === 'yes' && $layout === 'map') && $jobs->isNotEmpty();
            ...
            <div class="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                <div class="display-flex2">
                    ...
                    <div class="box-view-type">
                        <a class="view-type layout-job" href="?layout=list" data-layout="list">                       
                            <img src="{{ Theme::asset()->url('imgs/template/icons/icon-list.svg') }}" alt="{{ __('List layout') }}">
                        </a>
                        <a class="view-type layout-job" href="?layout=grid" data-layout="grid">
