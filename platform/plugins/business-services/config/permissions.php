...
return [
    ...
    [
        ...
        'flag' => 'business-services.service-industries.index',
        'parent_id' => 'plugins.business-services',
    ],
    [
        'name' => 'Create',
        'flag' => 'business-services.service-industries.create',
        'parent_flag' => 'business-services.packages.index',
    ],
    [
        'name' => 'Edit',
        'flag' => 'business-services.service-industries.edit',
        'parent_flag' => 'business-services.packages.index',
    ],
    [
        'name' => 'Delete',
        'flag' => 'business-services.service-industries.destroy',
        'parent_flag' => 'business-services.packages.index',
    ],
];
