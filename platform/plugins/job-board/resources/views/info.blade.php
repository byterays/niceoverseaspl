...
<x-core::datagrid>
    ...
    <x-core::datagrid.item>
        ...
        {{ $jobApplication->job->company->name }}, {{ $jobApplication->job->country->name }}
    ...
    <x-core::datagrid.item>
        ...
        <a href="{{ route(auth()->check() && is_in_admin(true) ? 'job-applications.download-cv' : 'public.account.applicants.download-cv', $jobApplication->id) }}" target="_blank" class="d-flex align-items-center gap-1">
